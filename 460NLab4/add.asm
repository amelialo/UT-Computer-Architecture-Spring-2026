...
;test protection
AND R5, R5, #0
STW R1, R5, #0  ;try to store sum at x0000


; test unaligned
;LEA R5, LOCC017
;LDW R5, R5, #0      ; R5 = xC017
;STW R1, R5, #0      ; attempt to store/load word odd address

;test unkown opcode
;.FILL xA000         ; opcode is 10  
HALT
